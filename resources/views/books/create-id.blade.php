...
@enderror" id="id" name="id" required>
@error('id')
<div class="invalid-feedback">
{{ $message }}
</div>
...
<div class="mb-3">
<label for="pages" class="form-label">Pagínas</label>
<input type="number" class="form-control @error('pages') is-invalid
@enderror" id="pages" name="pages" required>
@error('pages')
<div class="invalid-feedback">
{{ $message }}
</div>
...
<div class="mb-3">
<label for="cover_image" class="form-label">Título</label>
<input type="file" class="form-control @error('cover_image') is-invalid
@enderror" id="cover_image" name="cover_image" required>
@error('cover_image')
<div class="invalid-feedback">
{{ $message }}
</div>
...
<div class="mb-3">
<label for="publisher_id" class="form-label">ID da Editor(a)</label>
...
<input type="number" class="form-control @error('category_id')
is-invalid @enderror" id="category_id" name="category_id" required>
@error('category_id')
<div class="invalid-feedback">
    {{$message}}
</div>
