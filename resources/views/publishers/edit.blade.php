...
<div class="container">
    ...
    <form action="{{ route('publishers.update', $publisher) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('id') is-invalid @enderror" id="name" name="id" value="{{ old('id', $publisher->id) }}" required>
            @error('id')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('password') is-invalid @enderror" id="name" name="password" value="{{ old('password', $publisher->password) }}" required>
            @error('password')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
