...
@section('content')
<div class="container">
    <h1 class="my-4">Lista de Editor(a)</h1>
    ...
    <table class="table table-striped">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('publishers.destroy', $publisher) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm" onclick="return confirm('Deseja excluir esta publicidade?')">
            ...
            @empty
                <tr>
                    <td colspan="3">Nenhum Editor(a) encontrado.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
